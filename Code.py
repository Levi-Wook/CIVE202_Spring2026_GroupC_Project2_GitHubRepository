...
def calc_fine_agg_Y(percent_fine_G, sg_fine_N, volume_X):
    calc_fine_agg_Y = 62.4 * (percent_fine_G/100) * sg_fine_N * volume_X
    return calc_fine_agg_Y

def calc_coarse_agg_Z(percent_coarse_H, sg_coarse_O, volume_X):
    calc_fine_agg_Y = 62.4 * (percent_coarse_H/100) * sg_coarse_O * volume_X
    return calc_fine_agg_Y

def calc_other_agg_AA(percent_other_I, sg_other_P, volume_X):
    calc_fine_agg_Y = 62.4 * (percent_other_I/100) * sg_other_P * volume_X
    return calc_fine_agg_Y
...
Y = calc_fine_agg_Y(percent_fine_G, sg_fine_N, volume_X)
Z = calc_coarse_agg_Z(percent_coarse_H, sg_coarse_O, volume_X)
AA = calc_other_agg_AA(percent_other_I, sg_other_P, volume_X)
